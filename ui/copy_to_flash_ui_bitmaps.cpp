...
void wxCrafterfd8JZ6InitBitmapResources()
{
    ...
    XRC_ADD_FILE(wxT("XRC_resource/copy_to_flash_ui_bitmaps.cpp$_media_nick_FILES_src_my_flash_copy_ui_copy_to_flash_ui_bitmaps.xrc"), xml_res_file_0, xml_res_size_0, wxT("text/xml"));
    wxXmlResource::Get()->Load(wxT("memory:XRC_resource/copy_to_flash_ui_bitmaps.cpp$_media_nick_FILES_src_my_flash_copy_ui_copy_to_flash_ui_bitmaps.xrc"));
}
